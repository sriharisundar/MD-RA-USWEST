...
$gdxin %gdxincname%
$load ststorageegu, ltstorageegu, tech, dacstech, thermaltech, CCStech, nucleartech, CCtech, renewtech, solartech, windtech, storagetech, ststoragetech, ltstoragetech, prmH
$load pNMaxWind, pNMaxSolar, pNMaxNuclear, pNMaxCC, pNMaxCCS, pNMaxDACS, pPMaxSto, pEMaxSto
$load pNMaxRegionalWind, pNMaxRegionalSolar, pNMaxTotalWind, pNMaxTotalSolar, pWSGenAsFracOfDemand, pCapactech, pCapacderatetech, pHrtech, pOpcosttech
...
maxRegionalWind(z).. sum(windtech$[pGenzonetech(windtech)=ORD(z)],vN(windtech)) =l= pNMaxRegionalWind(z);
