...
def addGeneratorSets(db,genFleet):
    ...
    reFTs = ['Wind','Solar'] #removed 'Hydro' on 1/6/23
    ...
    addSet(db,genFleet['GAMS Symbol'].loc[genFleet['FuelType'] == 'Hydro'].tolist(),'hydroegu')
...
def addPlanningReserveHourSubset(db,planningReserveHour):
    addSet(db,[str(planningReserveHour)],'prmH')
